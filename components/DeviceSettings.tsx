...
import { 
  ...
  ListFilter, Search, Check, Trash, Columns, Layout
} from 'lucide-react';
            ...
            {isClockInDevice ? (
              <>
                <div className="space-y-1">
                  ...
                  <input type="text" value={formData.factoryArea} onChange={(e) => setFormData({...formData, factoryArea: e.target.value})} className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all" />
                </div>
                <div className="space-y-1">
                  <label className="text-sm font-semibold text-slate-700 flex items-center">
                    <MapPin size={14} className="mr-1.5 text-blue-500" /> 設備樓層
                  </label>
                  <input type="text" value={formData.floor} onChange={(e) => setFormData({...formData, floor: e.target.value})} className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all" />
                </div>
                <div className="space-y-1">
                  <label className="text-sm font-semibold text-slate-700 flex items-center">
